...
// Backwards-compatible aliases for TAB/other plugins still using %bits_*% placeholders.
public class BitsLegacyExpansion extends PlaceholderExpansion {

    @Override
    public String getIdentifier() { return "bits"; }
